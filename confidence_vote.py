...
class ConfidenceVote(Vote):
	...
	def alpha_vote(self,key):
		...
		for cid in self.scored_tweets[key]:
				...
				# this beta should/will always be less than baseline or this logic is stupid
	...
	def evaluate_results(self):
		print "Aggregating results from alpha_result_dict"
		agg_dict = {}
		for key in self.alpha_result_dict:
			...
			for aval in alphas:
				...
				for res_list in self.alpha_result_dict[key][aval]:
					...
					agg_dict[key][label] = agg_dict[key].get(label,0) +votes
						#print agg_dict[key]
